/**
 * @file InitialBoardView.java
 * @author Alex Rodriguez
 * @brief InitialBoardView controller specification.
 */
package view;
 ...
 * @brief <p> This class represents the scene controller of the initial board view  .</p>
 * By Alex Rodriguez
 */
public class InitialBoardView {
