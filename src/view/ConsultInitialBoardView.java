/**
 * @file ConsultInitialBoardView.java
 * @author Alex Rodriguez
 * @brief ConsultInitialBoardView controller specification.
 */
package view;
 ...
 * @brief <p> This class represents the scene controller of the consult initial board view.</p>
 * By Alex Rodriguez
 */
public class ConsultInitialBoardView {

    /*CREATOR*/
    /**
     * @brief Class creator.
     * */
    public ConsultInitialBoardView() {
    }
    ...
    public void goToMenu() throws IOException {
        Stage currentWindow = (Stage) goToMenu.getScene().getWindow();
        currentWindow.close();
    }
